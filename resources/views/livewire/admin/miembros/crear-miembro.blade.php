    ...
    <form wire:submit.prevent="crearMiembro">
        ...
        <div class="form-group">
            ...
            <input wire:model="phone" type="number" maxlength="10"
                class="form-control  @error('phone')  border-danger @enderror" id="phone" aria-describedby="errorPhone"
        ...
        <div class="form-group">
            ...
            <textarea wire:model="miembroKi" type=" text"
                class="form-control  @error('miembroKi')  border-danger @enderror" id="miembroKi"
                aria-describedby="errorMiembroKi" placeholder="{{__('messages.members')}}" rows="3">
                </textarea>
        ...
        <div class="form-group">
            ...
            <textarea wire:model="miembroEs" type="text"
                class="form-control  @error('miembroEs')  border-danger @enderror" id="miembroEs"
                aria-describedby="errorMiembroEs" placeholder="{{__('messages.members')}}" rows="3">
                </textarea>
        ...
        <div class="form-group">
            ...
            <textarea wire:model="miembroEn" type=" text"
                class="form-control  @error('miembroEn')  border-danger @enderror" id="miembroEn"
                aria-describedby="errorMiembroEn" placeholder="{{__('messages.members')}}" rows="3">
                </textarea>
        ...
        <x-adminlte-input wire:model="instagram" name="instagram" label="{{__('messages.instagram')}}"
            ...
            <x-slot name="prependSlot">
                <a href="{{$instagram}}" class="btn text-light" target="_blank" style=" background: radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f
                    60%,#285AEB 90%);">
        ...
        <div wire:ignore class="form-group">
            ...
            <select wire:model="cargosSelect" class="border form-control selectpicker " title="{{__('menu.cargo')}}"
                name="miembros[]" id="miembros" multiple required>
