<div class="">
    ...
    <div class="row mb-1 ">
        ...
        <a href="{{route('admin.agenda.modulos.create',[],false)}}"
    ...
    <div class="table-responsive" wire:loading.remove>
        <table id="modulos" class="table mt-2 sortable">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">{{__('adminlte::menu.modulos')}}
                        <span style="cursor: pointer;" class="float-right text-sm">
                            <i class="fas fa-arrow-up text-muted"></i>
                            <i class="fas fa-arrow-down text-muted"></i>
                        </span>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @livewire('admin.agenda.modulos.editar-modulo', ['modulo' => $modulo],
                        key('item-modulo-'.$modulo->idModulo))
                            ...
                            <x-adminlte-button class="align-self-stretch mb-2 mb-sm-0" type="submit" theme="primary"
                                ...
                                data-target="#modalModulo{{$modulo->idModulo}}" />
                            <x-adminlte-button class="align-self-stretch"
                            wire:click="$emit('alertDelete', {{$modulo->idModulo}})" type="submit" theme="danger"
        ...
        {{$modulos->links('pagination::bootstrap-5')}}
    ...
    window.addEventListener('showToast', e => {
            $('#modalModulo'+e.detail.idModulo).modal('hide')
...
// El siguiente código es el Alert utilizado
    Livewire.on('alertDelete', idModulo=>{
        ...
        if (result.isConfirmed) {
            ...
            Livewire.emit('deleteModulo',idModulo);
